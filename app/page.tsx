...
<div className="flex space-x-2 overflow-x-auto pb-2 scrollbar-hide scroll-smooth">
  {[
    ...
    <a
      key={path}
      href={`/${path}`}
      className="whitespace-nowrap border border-[#EBDEC8] text-[#EBDEC8] rounded-full px-5 py-2 text-sm shrink-0 bg-transparent hover:bg-black transition-all duration-200 hover:scale-[1.03]"
    >
      {label}
    </a>
  ))}
